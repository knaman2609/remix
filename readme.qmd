...
│  ├─ Lyria (via Gemini API) → AI stem regeneration │
...
```
The backend calls Google's Lyria API (via the Generative Language API) to generate a replacement stem matching that style. The new audio replaces the original in the Tone.js player.
