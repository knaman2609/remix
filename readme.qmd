...
description: "AI-powered music stem separation and style swapping"
format: gfm
---
...
# Set your Gemini API key (use .env file to avoid exposing in shell history)
...
| GET | `/api/analyze/{job_id}` | Get key/BPM/remix suggestions |
