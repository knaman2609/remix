...
# 2. Start everything (requires Docker Compose V2; use `docker-compose` for older versions)
...
# Set your Gemini API key (use .env files in production; never commit secrets)
# Linux/macOS:
