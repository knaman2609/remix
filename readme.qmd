...
- Gemini API key (free at [https://aistudio.google.com/apikey](https://aistudio.google.com/apikey))
:::
...
::: {.callout-tip}
The Docker setup auto-detects NVIDIA GPUs for faster processing.
:::
...
When the user clicks "Swap style" on a stem and picks a new style, the frontend calls `POST /api/swap-stem`:
